...
export const RECIPES: Recipe[] = [
  ...
  },
  {
    category: "밀크쉐이크",
    name: "플레인밀크쉐이크	ICE",
    recipe: "블렌더볼 / 밀크쉐이크베이스 180g + 설탕시럽 3펌프 + 밀크쉐이크파우더 40g + 얼음 / 믹스 3번",
  ...
  },
  {
    ...
    name: "팥절미밀크쉐이크	ICE",
    recipe:
      "블렌더볼 / 밀크쉐이크베이스 150g + 설탕시럽 3펌프 + 밀크쉐이크파우더 40g + 빙수팥 40g + 얼음 / 믹스 3번 / 빙수팥 60g + 인절미 20g",
  ...
  },
  {
    ...
    name: "쿠키밀크쉐이크	ICE",
    recipe:
      "블렌더볼 / 밀크쉐이크베이스 150g + 설탕시럽 3펌프 + 밀크쉐이크파우더 40g + 얼음 / 믹스 3번 / 로투스크럼블 15g 섞고 / 컵 벽면에 카라멜 소스 두르기 / 로투스크럼블 10g + 로투스 1개",
  ...
  },
  {
    ...
    name: "캔디소다밀크쉐이크	ICE",
    recipe:
      "블렌더볼 / 밀크쉐이크베이스 160g + 설탕시럽 3펌프 + 밀크쉐이크파우더 40g + 얼음 / 믹스 3번 / 컵에 150선까지 따르고 / 캔디소다베이스 40g 섞고 / 나머지 따르기",
  ...
  },
  {
    ...
    name: "커피밀크쉐이크	ICE",
    recipe:
      "블렌더볼 / 밀크쉐이크베이스 150g + 설탕시럽 3펌프 + 밀크쉐이크파우더 50g + 얼음 / 믹스 3번 / 에스프레소 2샷",
  ...
  },
  {
    category: "신메뉴",
    name: "리얼 믹스 커피",
    recipe: "블렌더볼 / 커피베이스 200g + 바닐라시럽 2펌프 + 얼음 60g / 믹스 2번 / 얼음",
    image_url: "images/빅포즈_제로_바나나__리얼_믹스_커피.jpg",
  },
  {
    category: "신메뉴",
    name: "제로 리얼 믹스 커피",
    recipe: "블렌더볼 / 제로커피베이스 200g + 바닐라시럽 2펌프 + 얼음 60g / 믹스 2번 / 얼음",
    image_url: "images/빅포즈_제로_리얼_믹스_커피.jpg",
  },
  {
    category: "신메뉴",
    name: "빅포즈 리얼 믹스 커피",
    recipe: "블렌더볼 / 커피베이스 300g + 바닐라시럽3펌프 + 얼음 90g / 믹스 2번 / 얼음",
    image_url: "images/빅포즈_리얼_믹스_커피.jpg",
  },
  {
    category: "신메뉴",
    name: "빅포즈 제로 리얼 믹스 커피",
    recipe: "블렌더볼 / 제로커피베이스 300g + 바닐라시럽 3펌프 + 얼음 90g / 믹스 2번 / 얼음",
    image_url: "images/빅포즈_제로_리얼_믹스_커피.jpg",
  },
  {
    category: "신메뉴",
    name: "바나나 리얼 믹스 커피",
    recipe: "블렌더볼 / 커피베이스 200g + 바닐라시럽 2펌프 + 바나나라떼파우더 30g + 얼음 60g / 믹스 2번 / 얼음",
    image_url: "images/빅포즈_제로_바나나__리얼_믹스_커피.jpg",
  },
  {
    category: "신메뉴",
    name: "제로 바나나 리얼 믹스 커피",
    recipe: "블렌더볼 / 제로커피베이스200g + 바닐라시럽2펌프 + 저당바나나라떼파우더 30g + 얼음 60g / 믹스 2번 / 얼음",
    image_url: "images/빅포즈_제로_바나나__리얼_믹스_커피.jpg",
  },
  {
    category: "신메뉴",
    name: "빅포즈 바나나 리얼 믹스 커피",
    recipe: "블렌더볼 / 커피베이스 300g + 바닐라시럽 3펌프 + 바나나라떼파우더 45g + 얼음 90g / 믹스 2번 / 얼음",
  ...
  },
  {
    ...
    recipe:
      "블렌더볼 / 제로커피베이스 300g + 바닐라 시럽 3펌프 + 저당바나나라떼파우더 45g + 얼음 90g / 믹스 2번 / 얼음",
    image_url: "images/빅포즈_제로_바나나__리얼_믹스_커피.jpg",
  },
  {
    category: "신메뉴",
    name: "오렌지 사샷추",
    recipe: "아이스컵 / 오렌지베이스 50g + 사이다 250g / 믹스 / 얼음 / 에스프레소 2샷",
    image_url: "images/빅포즈_오렌지_사샷추_디카페인.jpg",
  },
  {
    category: "신메뉴",
    name: "레몬 사샷추",
    recipe: "아이스컵 / 레몬베이스 50g + 사이다 250g / 믹스 / 얼음 / 에스프레소 2샷",
    image_url: "images/빅포즈_레몬_사샷추_디카페인.jpg",
  },
  {
    category: "신메뉴",
    name: "빅포즈 오렌지 사샷추",
    recipe: "아이스컵 / 오렌지베이스 75g + 사이다 380g / 믹스 / 얼음 / 에스프레소 4샷",
    image_url: "images/빅포즈_오렌지_사샷추_디카페인.jpg",
  },
  {
    category: "신메뉴",
    name: "빅포즈 레몬 사샷추",
    recipe: "아이스컵 / 레몬베이스 75g + 사이다 380g / 믹스 / 얼음 / 에스프레소 4샷",
    image_url: "images/빅포즈_레몬_사샷추_디카페인.jpg",
  },
  {
    category: "신메뉴",
    name: "오렌지 사샷추 콜드브루",
    recipe: "아이스컵 / 오렌지베이스 50g + 사이다 250g / 믹스 / 콜드브루 1팩 / 얼음",
    image_url: "images/오렌지_사샷추_콜드브루.jpg",
  },
  {
    category: "신메뉴",
    name: "레몬 사샷추 콜드브루",
    recipe: "아이스컵 / 레몬베이스 50g + 사이다 250g / 믹스 / 콜드브루 1팩 / 얼음",
  ...
  },
  {
    ...
    name: "딸기 모찌 밀크쉐이크",
    recipe:
      "블렌더볼 / 밀크쉐이크베이스 150g + 밀크쉐이크 파우더 40g / 설탕시럽 2펌프 + 딸기베이스 90g + 얼음 280g / 믹스 3번 / 휘핑크림 30g + 찹쌀떡 4개",
    image_url: "images/딸기_모찌_밀크쉐이크.jpg",
  },
  {
    category: "과일주스",
    name: "국내산 딸기주스",
    recipe: "블렌더볼 / 갈아만든딸기 1팩 + 정수 180g / 믹스 2번 / 아이스컵 옮긴 후 얼음 가득",
  ...
  },
  {
    category: "시즌메뉴",
    name: "하와이안에이드",
    recipe: "아이스컵 /  캔디소다베이스 10g + 파인애플베이스 30g + 사이다 200g / 섞기 / 후르츠칵테일고형물 30g / 얼음",
